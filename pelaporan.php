                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    <tr>
                      <td>Kecelakaan</td>
                      <td>
                        <i class="fas in fa-circle fa-xs text-danger mr-2"></i><span>Darurat</span>
                      </td>
                      <td>Ayu Wiradani</td>
                      <td>Masyarakat</td>
                      <td>01 Februari 2021</td>
                      <td>
                        <i class="fas in fa-circle fa-xs text-success mr-2"></i><span>Valid</span>
                      </td>
                      <td>
                        <div class="container-crud">
                          <a href="detail_pelaporan_darurat.php" class="btn btn-primary btn-icon-split btn-sm">
                    ...
                    <tr>
                      <td>Jalan Rusak</td>
                      <td>
                        <i class="fas in fa-circle fa-xs text-primary mr-2"></i><span>Keluhan</span>
                      </td>
                      ...
                      <td>
                        <div class="container-crud">
                          <a href="detail_pelaporan_keluhan.php" class="btn btn-primary btn-icon-split btn-sm">
                            <span class="icon text-white-50">
                              <i class="fas fa-file"></i>
                            </span>
                            <span class="text">Detail</span>
