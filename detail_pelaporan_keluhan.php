...
<head>
  ...
  <title>Detail Pelaporan Keluhan | Instansi</title>
          ...
          <div class="row mt-4">
            <div class="col-xl-4 order-xl-2">
              <div class="card card-profile shadow">
                <div class="foto">
                  <img src="img/gbr2.jpg" alt="Image placeholder" class="card-img-top">
                </div>
                <div class="row justify-content-center">
                  <div class="col-lg-3 order-lg-2">
                    <div class="card-profile-image" style="background-size: cover;">
                      <a href="#">
                        <img src="img/user.jpg" class="rounded-circle gallery-modal profil-foto">
                      </a>
                    </div>
                  </div>
                </div>
                <div class="card-body" style="margin-top: 50px;">
                  <div class="text-center pt-3">
                    ...
                    <div class="d-flex justify-content-center align-items-center">
                      <i class="fas in fa-circle fa-xs text-secondary mr-2"></i><span>Menunggu Validasi</span>
                    </div>
                  </div>
                  <hr class="my-4" />
                  <div class="row">
                    <div class="col">
                      <div class="card-profile-stats d-flex justify-content-center">
                        ...
                        <div class="d-flex flex-column align-items-center" style="flex: 33%;">
                          ...
                          <span class="h6">01 Feb 2020</span>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="card shadow">
                <div class="card-header">
                  <div class="col-12 d-flex justify-content-between align-items-center">
                    <h6 class="m-0 font-weight-bold text-primary">Detail Data Keluhan</h6>
                    <!-- tombol kembali -->
                ...
                <div class="card-body">
                  <form>
                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="form-group">
                          <label class="form-control-label">Deskripsi keluhan</label>
                          <textarea rows="4" class="form-control"
                            placeholder="Deskripsi keluhan">Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestias architecto ut tempora enim doloribus sint autem voluptas ullam corrupti beatae.</textarea>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-lg-4">
                        <div class="form-group">
                          <label class="form-control-label" for="input-last-name">Akomodasi</label>
                          <input type="text" id="input-last-name" class="form-control" placeholder="Akomodasi"
                            value="Akomodasi A">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="form-group">
                          <label class="form-control-label">Foto keluhan</label>
                          <div class="foto-pelaporan">
                            <div class="foto">
                              <img src="img/jalan1.jpg" class="img-fluid gallery-modal">
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-lg-4">
                        <div class="form-group">
                          <label class="form-control-label" for="input-country">Desa Adat</label>
                          <input type="text" id="input-country" class="form-control" placeholder="Desa" value="Desa A">
                        </div>
                      </div>
                      <div class="col-lg-4">
                        <div class="form-group">
                    ...
                    <div class="form-group">
                      <label class="form-control-label">Peta keluhan</label>
                      <iframe
