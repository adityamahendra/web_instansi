                    ...
                    <div class="row">
                      ...
                      <div class="profile-head pl-4">
                        ...
                        <div class="d-flex mt-3">
                          <div class="badge badge-success mr-2">Admin</div>
                        </div>    
                        ...
                        <ul class="nav nav-tabs pt-4" id="myTab" role="tablist">
                          ...
                          <li class="nav-item">
                            <a class="nav-link" id="instansi-tab" data-toggle="tab" href="#instansi" role="tab"
                              aria-controls="instansi" aria-selected="false">Alamat</a>
                          </li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div class="tab-pane fade show active" id="profil" role="tabpanel" aria-labelledby="profil-tab">
                      ...
                      <form>
                        <div class="d-flex">
                          <div class="col-md-8">
                            <div class="form-group">
                              <label class="form-control-label" for="nama">NIP</label>
                        ...
                        <div class="d-flex">
                          <div class="col-lg-4">
                            <div class="form-group">
                              <label class="form-control-label" for="input-email">Instansi</label>
                              <input type="text" id="instansi" class="form-control" value="Pemadam Kebakaran"
                          ...
                          <div class="col-lg-4">
                            <div class="form-group">
                              ...
                              <input type="text" id="input-last-name" class="form-control" placeholder="Status"
                                value="Aktif">
                            </div>
                          </div>
                        </div>
        ...
        <div class="modal-body">
          <form>
            <div class="form-group">
              ...
              <input type="text" class="form-control form-control-lg" placeholder="Nama Lengkap" value="Ari Wiradana">
            </div>
            ...
            <div style="display:none" id="password">
              <div class="form-group mt-2 row">
                <div class="col-sm-6">
                  <label class="col-form-label-sm">Kata Sandi Lama</label>
                  <input type="password" class="form-control form-control-lg" placeholder="Kata Sandi Lama"
                    value="000120102010212">
                </div>
                <div class="col-sm-6">
                  <label class="col-form-label-sm">Kata Sandi Baru</label>
            ...
            <div class="form-group row mt-2">
              <div class="col-md-6 mb-sm-0">
                ...
                <input type="number" class="form-control form-control-lg" placeholder="No. Telp" value="082717282818">
              </div>
              <div class="col-md-6">
                <label for="status_aktif" class="col-form-label-sm">Status</label>
            ...
            <div class="form-group">
              <label class="col-form-label-sm" for="exampleFormControlFile1">Unggah Foto</label>
              <input type="file" class="form-control-file" id="exampleFormControlFile1">
            </div>
            <button style="margin: 5px 0 10px 0;" type="submit" class="btn btn-primary">Simpan</button>
          </form>
        </div>
      </div>
    </div>
